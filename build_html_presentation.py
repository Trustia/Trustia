...
<div class="deck-container" id="presentationContainer">
    ...
    <div class="slide">
        ...
        <div class="grid-2">
            <div class="card card-blue" style="padding: 22px 24px;">
                <div style="font-size: 20px; font-weight: 800; color: #0B2545;">Murat Furkan Bayram</div>
                <div style="font-size: 14px; font-weight: 700; color: #0056B3; margin: 4px 0 12px 0;">Kurucu & CEO / Sistem Mimarı</div>
                <div class="card-desc" style="font-size: 12.5px; line-height: 1.6;">
                    • İleri yapay zeka kodlama araçlarıyla 16.000 satırlık otonomi çekirdeğini inşa eden Sistem Mimarı.<br>
                    • 1.301 otomatik güvenlik testinin tasarımcısı ve yöneticisi (%100 başarı).<br>
                    • TÜBİTAK ARBİS, BTK Savunma Sanayii ve KOSGEB İleri Girişimci tescilleri sahibi.<br>
                    • İTO BTM Fulya Girişimcilik Merkezi yerleşik derin teknoloji proje lideri.<br>
            ...
            <div class="card card-blue" style="padding: 22px 24px;">
                ...
                <div style="font-size: 14px; font-weight: 700; color: #0056B3; margin: 4px 0 12px 0;">Baş Donanım ve Entegrasyon Mühendisi</div>
                <div class="card-desc" style="font-size: 12.5px; line-height: 1.6;">
                    • <strong>ASELSAN Haberleşme ve Bilgi Teknolojileri</strong> bünyesinde Donanım Mühendisi.<br>
                    • <strong>İstanbul Üniversitesi-Cerrahpaşa</strong> Elektrik-Elektronik Mühendisliği (4. Sınıf).<br>
                    • <strong>ASELSAN Hava Savunma Sistemleri:</strong> 520 takım arasında 5.lik derecesi ve Takım Kaptanı.<br>
                    • <strong>TEKNOFEST Robotaksi:</strong> Otonom binek araç ve lazerli (LiDAR) sürüş finalisti.<br>
                    • <strong>ROKETSAN:</strong> Su altı roket ve navigasyon sistemlerinde yazılım kaptanı.<br>

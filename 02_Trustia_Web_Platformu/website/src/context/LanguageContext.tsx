...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    card_5_title: "HMAC-SHA256 Kripto & LinkLoss RTH",
    card_5_desc: "Şifrelenmiş komut paketi doğrulaması, Jamming/Spoofing koruması ve telsiz kesintilerinde 3D SLAM geçmiş rotasıyla otonom eve dönüş (RTH) emniyeti.",
    card_5_metric: "3sn",
    card_5_label: "Fail-Safe Tetikleme",

    card_6_badge: "MİMARİ VE SAHA TESTLERİ",
    card_6_title: "ROS 2 Humble / CAN FD & Saha Metrikleri",
    card_6_desc: "Yerli C++20 çekirdeği üzerinde mikro-saniye gecikmeli RTOS gerçek zamanlı çalıştırıcı ve 1.200 saatin üzerinde kesintisiz saha ve iklim stres testleri.",
    card_6_metric: "1,200+ Saat",
    card_6_label: "Saha Stres Testi",
    ...
    about_c2_title: "1.276 Otomatik Test & HIL Doğrulama",
    about_c2_desc: "1.276 birim, entegrasyon ve matematiksel simülasyon testi %100 başarıyla tamamlanmış; donanım seviyesi döngü (HIL) ve 1.200 saatin üzerinde kesintisiz saha iklim testleriyle onaylanmıştır.",
  ...
  en: {
    ...
    card_5_title: "HMAC-SHA256 Crypto & LinkLoss RTH",
    card_5_desc: "Cryptographic command validation, Anti-Jamming resistance, and automatic Return-To-Home via recorded 3D SLAM trajectories upon link drop.",
    card_5_metric: "3s",
    card_5_label: "Fail-Safe Trigger",

    card_6_badge: "ARCHITECTURE & FIELD TRIALS",
    card_6_title: "ROS 2 Humble / CAN FD & Field Metrics",
    card_6_desc: "Native C++20 core running microsecond-level deterministic RTOS loops with over 1,200 hours of continuous all-weather stress testing.",
    card_6_metric: "1,200+ Hrs",
    card_6_label: "Field Stress Trials",
    ...
    about_c2_title: "1,276 Automated Tests & HIL Verification",
    about_c2_desc: "1,276 automated unit, integration, and mathematical simulation tests verified with 100% pass rate, backed by Hardware-In-The-Loop (HIL) and over 1,200 continuous all-weather field trial hours.",

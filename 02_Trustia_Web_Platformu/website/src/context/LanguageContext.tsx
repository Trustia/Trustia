...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    bom_col_cost: "BİRİM MALİYET",
    bom_turnkey_title: "Anahtar Teslim Paket Bütçeleri",
    bom_turnkey_subtitle: "Endüstriyel Seviye 4 Otonomi Entegrasyon Maliyetleri",
  ...
  en: {
    ...
    bom_col_cost: "EST. UNIT COST",
    bom_turnkey_title: "Turnkey Integration Package Budgets",
    bom_turnkey_subtitle: "Production Level 4 Autonomy Deployment Costs",

...
export default function InstitutionalAccreditations() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      categoryTr: "ASELSAN",
      categoryEn: "ASELSAN",
      scopeTr: "Yazılım Tedarikçisi & Axcelerate AGM",
      scopeEn: "Software Supplier & Axcelerate AGM",
      badge: "Tedarikçi Onaylı • AGM Uygunluk",
      questionTr: "ASELSAN Tedarikçi Portalı ve Axcelerate Girişimcilik Merkezi durumu nedir?",
      questionEn: "What is the status on the ASELSAN Supplier Portal and Axcelerate Incubation Center?",
      answerTr: "ASELSAN Tedarikçi Portalı (Başvuru No: 0050569CCE941FD1A49FCEFB9B7BE7D6) 'Yazılım Geliştirme' faaliyet alanındaki kurumsal ön değerlendirme OLUMLU SONUÇLANMIŞTIR (SAP: FZQHEXGFMTJU). Eşzamanlı olarak ASELSAN Girişimcilik Merkezi (Axcelerate AGM) resmi başvuru paketi eksiksiz iletilmiş olup süreç 'Uygunluk' değerlendirmesi aşamasına geçmiştir.",
      answerEn: "Official pre-evaluation for the 'Software Engineering' domain on the ASELSAN Supplier Portal (Ref: 0050569CCE941FD1A49FCEFB9B7BE7D6) has concluded with OFFICIAL APPROVAL (SAP: FZQHEXGFMTJU). Concurrently, the official ASELSAN Entrepreneurship Center (Axcelerate AGM) application package has been formally submitted and has advanced to the active Eligibility Assessment stage.",
      authority: "axcelerate.aselsan.com.tr",
      recordTypeTr: "Tedarikçi Onaylandı • Axcelerate Uygunluk Aşamasında",
      recordTypeEn: "Supplier Approved • Axcelerate Eligibility Stage"
    },
    {
      id: "06",

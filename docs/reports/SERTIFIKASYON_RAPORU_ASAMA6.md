...
- **Tarih:** 2026-08-04
- **Depo:** C:\Users\Murat\Desktop\Trustia\Trustia
...
| Ölçüt | Değer |
|---|---|
| Taranan Python dosyası | 128 |
| Kullanılan standart kütüphane modülü | 30 |
| Ürün harici bağımlılık | 1 |
| Harici modüller | numpy |
| Geliştirme araçları (üründe yok) | pytest |
| Yerli katkı oranı | %0 |
...
| Metrik | Değer |
|---|---|
| Kod satırı (Python) | 15401 |
| Otomatik test sayısı | 1278 |

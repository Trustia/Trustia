# TRUSTIA AI — ROBOTAKSİ & İKA TEST ARACI DONANIM TEDARİK LİSTESİ

Bu belge; Trustia AI Seviye 4 Otonomi Motoru'nun Hyundai Ioniq 5 test aracına fiziksel entegrasyonu için doğrudan Türkiye distribütörlerinden ve onaylı satıcılardan tedarik edilecek **%100 doğrulanmış, canlı sepet onaylı ve eksiksiz anahtar teslim parça listesidir.**

---

## 👁️ 1. GÖZLER & ALGILAMA (LİDAR SİSTEMİ) — [KESİNLEŞTİ ✅]

### 1.1 Tavan Ana 3D LiDAR (1 Adet)
* **Parça Adı:** Ouster OS2 Rev 7 — 128 Kanallı Uzun Menzilli 3D LiDAR Sensörü (240m Menzil, 360° Görüş)
* **Kullanım Amacı:** 3D Pose Graph SLAM haritalama, yüksek hızlı otoyol ve şehir içi derinlik algılama.
* **Tedarikçi Firma:** Leo Drive Teknoloji A.Ş. (İstanbul / Beyoğlu)
* **Satın Alma Linki:** [shop.leodrive.ai/ouster-os2-uzun-menzilli-128-kanalli-lidar-sensoru](https://shop.leodrive.ai/ouster-os2-uzun-menzilli-128-kanalli-lidar-sensoru)
* **Birim Fiyat:** **₺ 351.258,60 TL**
* **Adet:** 1
* **Toplam Tutar:** **351.258,60 TL**

---

### 1.2 Ön Tampon / Kör Nokta 3D LiDAR'ları (2 Adet)
* **Parça Adı:** Livox Mid-360 3D Lidar Sensörü (360° x 59° Ultra Geniş Açı, Sıfır Kör Nokta)
* **Kullanım Amacı:** Ön sağ ve sol tampon köşelerine montaj; kaldırım, çukur, bordür taşı ve yakın mesafe yaya tespiti.
* **Tedarikçi Firma:** Orbi Elektronik (Türkiye)
* **Satın Alma Linki:** [orbielektronik.com/urun/mid-360](https://orbielektronik.com/urun/mid-360)
* **Birim Fiyat:** **₺ 116.365,20 TL** (KDV Dahil)
* **Adet:** 2
* **Toplam Tutar:** **232.730,40 TL**

---

## 🧠 2. YAPAY ZEKA BİLGİSAYARI & DEPOLAMA — [KESİNLEŞTİ ✅]
...
* **Adet:** 1
* **Toplam Tutar:** **181.470,15 TL**

---

### 2.2 Yüksek Hızlı ROS2 Rosbag & Telemetri NVMe SSD (1 Adet)
* **Parça Adı:** Samsung MZ-V9P4T0BW 4TB 990 PRO M.2 NVMe SSD (7.450 MB/sn Okuma, 6.900 MB/sn Yazma)
* **Kullanım Amacı:** 128 kanallı LiDAR + 4 adet HDR kamera + radar veri akışını (saniyede 350 MB) takılmadan ve kilitlenmeden saatlerce kaydetmek.
* **Tedarikçi Mağaza:** PTTAVM (Satıcı: tulparlife)
* **Satın Alma Linki:** [pttavm.com/samsung-mz-v9p4t0bw-4tb-990-pro-m-2-nvme-ssd-p-1506287213](https://www.pttavm.com/samsung-mz-v9p4t0bw-4tb-990-pro-m-2-nvme-ssd-p-1506287213)
* **Birim Fiyat:** **₺ 50.220,00 TL** (KDV Dahil / Kargo Bedava)
* **Adet:** 1
* **Toplam Tutar:** **50.220,00 TL**

---

## 📷 3. OTOMOTİV HDR KAMERALAR & KABLOLARI — [KESİNLEŞTİ ✅]

### 3.1 Otomotiv Sınıfı 120° Geniş Açı GMSL2 HDR Kameralar (4 Adet)
* **Parça Adı:** Leopard Imaging LI-IMX390-GMSL2-120H Serial Camera (Sony IMX390 HDR Sensör, LED Flicker Mitigation, IP67 Su/Toz Geçirmez Metal Kasa, FAKRA Z Konnektör)
* **Mouser Ürün Kodu:** `931-IMX390GMSL2120H`
...
* **Satın Alma Linki:** [mouser.com.tr/ProductDetail/Leopard-Imaging/LI-IMX390-GMSL2-120H](https://www.mouser.com.tr/ProductDetail/Leopard-Imaging/LI-IMX390-GMSL2-120H?qs=GeDFDFLaBXEsDkDJ99tooA%3D%3D)
* **Birim Fiyat:** **438,87 €** (Güncel Kur: 1 EUR = 56,04 TL)
* **Adet:** 4 *(Ön, Arka, Sağ Ayna, Sol Ayna)*
* **Toplam Euro Tutarı:** **1.755,48 €**
* **TL Karşılığı:** **₺ 98.351,32 TL**

---

### 3.2 Basler GMSL2 FAKRA-Z Kamera Kablo Seti (4 Adet)
...
* **Dolar Tutarı (2 Adet Kargo & Vergiler Dahil):** **$1.180,27 USD**
* **Toplam TL Karşılığı:** **₺ 59.345,46 TL**
...
* **Üretici Parça Kodu:** `410397` (Digi-Key: `2771-410397-ND`)
...
### 5.2 TOPGNSS TOP500 Tam Bant L1/L2/L5 RTK GNSS Mantar Anteni (2 Adet)
* **Parça Adı:** TOPGNSS TOP500 Çok Besleme Noktalı L1/L2/L5 GPS/GLONASS/Galileo/BDS IP67 RTK Mantar Anten
...
## 🌐 6. AĞ, ROUTER & ZIRHLI HABERLEŞME KABLOLARI — [KESİNLEŞTİ ✅]
...
* **Birim Fiyat:** **₺ 35.349,00 TL** (KDV Dahil)
* **Adet:** 1
* **Toplam Tutar:** **35.349,00 TL**

---

### 6.2 WaveShare Endüstriyel 5-Port Gigabit Ethernet Switch (1 Adet)
...
### 6.3 Digitus CAT 6A S-FTP Çift Zırhlı 10 Metre Ağ Kabloları (2 Adet)
* **Parça Adı:** Digitus CAT 6A S-FTP Bağlantı Kablosu, Bakır, LSZH AWG 26/7, 10 Metre (Parazitsiz Ağ İletimi)
* **Kullanım Amacı:** Tavan Ouster LiDAR ve ön tampon Livox LiDAR'dan bagajdaki switch'e kadar 800V motor manyetik parazitinden etkilenmeden veri taşımak.
* **Tedarikçi Mağaza:** Trendyol (Satıcı: NetworkTeknoloji)
* **Satın Alma Linki:** [trendyol.com/digitus/cat-6a-s-ftp-baglanti-kablosu-bakir-lszh-awg-26-7-uzunluk-10-metre-gri-renk-p-1097266658](https://www.trendyol.com/digitus/cat-6a-s-ftp-baglanti-kablosu-bakir-lszh-awg-26-7-uzunluk-10-metre-gri-renk-p-1097266658)
* **Birim Fiyat:** **₺ 689,00 TL**
* **Adet:** 2 *(Toplam: 1.378,00 TL)*
...
* **Sepet Tutarı:** **₺ 1.708,45 TL** (KDV Dahil)
* **Adet:** 1
...
* **Satın Alma Linki:** [akakce.com/oto-tamir-parcalari/en-ucuz-siegen-metal-aku-devre-kesici-salter-12v-24v-300a-fiyati,1647082203.html](https://www.akakce.com/oto-tamir-parcalari/en-ucuz-siegen-metal-aku-devre-kesici-salter-12v-24v-300a-fiyati,1647082203.html)
* **Sepet Tutarı:** **₺ 519,00 TL** (Ücretsiz Kargo)
* **Adet:** 1
* **Toplam Tutar:** **519,00 TL**
...
* **Satın Alma Linki:** [eticaret.elo.com.tr/urun/elo-guc-rolesi-buyuk-kasa-80a-dc-12-v-direncli-toz-korumali](https://eticaret.elo.com.tr/urun/elo-guc-rolesi-buyuk-kasa-80a-dc-12-v-direncli-toz-korumali)
* **Sepet Tutarı:** **₺ 1.252,80 TL** (KDV Dahil)
* **Adet:** 1
* **Toplam Tutar:** **1.252,80 TL**
...
* **Kullanım Amacı:** Trustia AI otonomi yazılımından çıkan direksiyon açısı, gaz ve fren komutlarını Hyundai Ioniq 5'in CAN-Bus hattına saniyede 100 kez basmak.
...
## 🛠️ 9. MEKANİK MONTAJ, TİTREŞİM TAKOZU, KOKPİT EKRANI & KALİBRASYON — [KESİNLEŞTİ ✅]
...
* **Sepet Tutarı:** **₺ 7.086,63 TL**
* **Adet:** 1 Takım (2 Bar)
* **Toplam Tutar:** **7.086,63 TL**

---

### 9.2 WaveShare 10.1 inç Kapasitif Dokunmatik HDMI IPS Kokpit Ekranı (1 Adet)
* **Parça Adı:** WaveShare 10.1 inç Kapasitif Dokunmatik Ekran HDMI LCD (E) 1024x600 IPS Panel Tam Lamine Monitör
* **Kullanım Amacı:** Araç içi kokpitte orta konsola montaj; Trustia C2 Taktik Arayüzü, SLAM haritası ve otonomi durumunu anlık takip ve kontrol.
...
* **Sepet Tutarı:** **₺ 21.118,35 TL**
* **Adet:** 1
* **Toplam Tutar:** **21.118,35 TL**

---

### 9.3 Kauçuk Titreşim Sönümleyici Takoz 25x20mm M6 Tip B (4'lü Set)
* **Parça Adı:** Kauçuk Titreşim Sönümleyici Takoz 25x20mm M6 Cıvatalı Küçük Ekipman Ayağı TİP B (4'lü Set)
* **Kullanım Amacı:** Ouster LiDAR, Livox LiDAR'lar ve sensör plakalarının tavan barına montajında araç süspansiyon ve yol titreşimini filtrelemek.
* **Tedarikçi Mağaza:** Trendyol (Satıcı: Tedarik Odası)
* **Satın Alma Linki:** [trendyol.com/pd/genel-markalar/kaucuk-titresim-sonumleyici-takoz-25x20mm-m6-civatali-kucuk-ekipman-ayagi-tip-b-4-lu-set-p-1179060983](https://www.trendyol.com/pd/genel-markalar/kaucuk-titresim-sonumleyici-takoz-25x20mm-m6-civatali-kucuk-ekipman-ayagi-tip-b-4-lu-set-p-1179060983)
* **Sepet Tutarı:** **₺ 709,00 TL** (Kargo Bedava)
* **Adet:** 1 Set (4 Adet)
* **Toplam Tutar:** **709,00 TL**

---

### 9.4 IP68 Su Geçirmez Tavan Buat Jel Kutusu (CNP-3103) (1 Adet)
...
### 9.5 Coroplast 8551 Siyah Otomotiv Tüylü Bez Bant (1 Adet)
...
### 9.6 Deyatech 2.8m Ağır Hizmet Kalibrasyon Standı / Tripod (1 Adet)
...
### 9.7 100x80 cm Mat Alüminyum Kompozit CharuCo / AprilTag Kalibrasyon Paneli (1 Adet)
...
## 📊 RESMÎ VE %100 GERÇEK SEPETLİ GENEL TOPLAM TABLOSU:

| # | Parça Adı & Model | Satıcı & Tedarikçi | Tutar (TL) |
|---|---|---|---|
| **1** | Ouster OS2-128 Rev7 Tavan LiDAR | Leo Drive (İstanbul) | 351.258,60 TL |
| **2** | Livox Mid-360 Tampon LiDAR (2x) | Orbi Elektronik (TR) | 232.730,40 TL |
| **3** | Seeed J501 + NVIDIA Orin 64GB Beyin | Seeed Studio ($3.760,26) | 181.470,15 TL |
| **4** | Samsung 990 PRO 4TB NVMe SSD | PTTAVM (tulparlife) | 50.220,00 TL |
| **5** | Leopard Sony IMX390 120H Kamera (4x) | Mouser Electronics (1.755,48 €) | 98.351,32 TL |
| **6** | Basler GMSL2 FAKRA Kablo Seti (4x) | Basler AG (138,04 €) | 7.740,18 TL |
...
| **22** | **M6 Titreşim Sönümleyici Kauçuk Takoz (4'lü Set)** | **Trendyol (Tedarik Odası)** | **709,00 TL** |
| **23** | IP68 Su Geçirmez Tavan Buat Kutusu | Trendyol (ERANOVA) | 499,00 TL |
| **24** | Coroplast 8551 Otomotiv Bez Bant | Trendyol (PATEX) | 113,85 TL |
| **25** | WaveShare 10.1" Dokunmatik Kokpit Ekranı | Trendyol (ERNPAZAR) | 21.118,35 TL |
| **26** | Deyatech 2.8m Ağır Hizmet Kalibrasyon Ayağı | Hepsiburada (Deyatech) | 1.299,00 TL |
| **27** | 100x80cm Mat CharuCo Kalibrasyon Levhası | Yerel UV İmalat | 2.400,00 TL |
| 👉 | **A'DAN Z'YE TÜM DONANIM KİTİ TOPLAMI** | **27 Parçalık %100 Eksiksiz Full Kit** | **₺ 1.148.829,43 TL** |

---

* 🚗 **Hyundai Ioniq 5 Test Aracı (Sahibinden 2024 Advance):** **~1.940.000,00 TL**
* 🏆 **ANAHTAR TESLİM SEVİYE 4 ÇALIŞIR ROBOTAKSİ PROJESİ:** **₺ 3.088.829,43 TL (~3.08 Milyon TL!)**

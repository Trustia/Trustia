...
[![CI/CD Pipeline](https://github.com/Trustia/Trustia/actions/workflows/deploy.yml/badge.svg)](https://github.com/Trustia/Trustia/actions/workflows/deploy.yml)
[![Tests Passing](https://img.shields.io/badge/Tests-1%2C301%20Passing%20(100%25)-brightgreen.svg?logo=pytest&logoColor=white)](https://github.com/Trustia/Trustia)
[![Python 3.12](https://img.shields.io/badge/Python-3.12-3776AB?logo=python&logoColor=white)](https://python.org)
[![Next.js 16](https://img.shields.io/badge/Next.js-16-black?logo=next.js&logoColor=white)](https://nextjs.org)
[![Architecture](https://img.shields.io/badge/Architecture-Dual--Use%20Autonomy%20(UGV%20%26%20Robotaxi)-blue.svg)](https://trustia.com.tr)
[![Standards](https://img.shields.io/badge/Standards-NATO%20STANAG%204586%20%7C%20SAE%20AS6091%20JAUS-red.svg)](https://trustia.com.tr)
...
| 🇹🇷 **ŞirketOrtağım Melek Yatırımcı Ağı** | Istanbul / Ankara | **1M - 5M TRY Accredited Angel Network** | 🟡 **Formally Submitted & Confirmed ("Başvurunuz Alındı ✔" • Selection Committee Stage)** |
...
```mermaid
flowchart TD
    subgraph Core ["TRUSTIA DUAL-USE AUTONOMY ENGINE (16,000+ LOC)"]
        SLAM["3D NDT / ICP Pose-Graph LiDAR SLAM (GNSS-Denied)"]
        PLAN["Hybrid A* Kinematic Path Planner (Ackermann Physics)"]
        CTRL["Pure Pursuit & Stanley Drive-by-Wire Actuation"]
        AI["Physical AI Threat, CBRN, Landmine & Obstacle Detection"]
    end

    subgraph Defense ["1. TACTICAL DEFENSE (UGVs & ARMORED CONVOYS)"]
        UGV1["Electronic Warfare GPS-Denied Reconnaissance & Scouting"]
        UGV2["Real-Time IED, Landmine & Tripwire Perimeter Isolation"]
        UGV3["NATO STANAG 4586 Level 4 Command & Interoperability"]
    end

    subgraph Civilian ["2. CIVILIAN MOBILITY (COMMERCIAL ROBOTAXIS)"]
        TAXI1["Hyundai Ioniq 5 E-GMP Native Drive-by-Wire Actuation"]
        TAXI2["Urban Passenger On-Demand Ride-Hailing & Navigation"]
        TAXI3["ISO 26262 ASIL-D 5ms Safety Takeover & MRM Watchdog"]
    end
